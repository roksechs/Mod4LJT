    ...
    abstract class CommonRegulation
    {
        ...
        public CommonRegulation()
        {
            this.blockRestrictions = new Dictionary<int, BlockRestriction>()
            {
                ...
                { (int) BlockType.Rocket,  new BlockRestriction(0, 251, 0.5f, 4f)},
                { (int) BlockType.Log,  new BlockRestriction(0, 251)},
                { (int) BlockType.CogMediumPowered, new BlockRestriction(0, 251, 0f, 2f) },
                { (int) BlockType.Wheel, new BlockRestriction(0, 251, 0f, 2f) },
                { (int) BlockType.LargeWheel, new BlockRestriction(0, 251, 0f, 2f) },
